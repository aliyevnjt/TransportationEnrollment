...
import {
  Container, Button, Col, Row, Alert, Form
...
function PaidReg(props) {
  ...
  const freeData = free.length > 0 ? {
    headers,
    options: free
  } : '';

  const paidData = paid.length > 0 ? {
    headers,
    options: paid
  } : '';
  ...
  let uniqueID = '';
  const returnURL = '';
  const cancelButtonURL = '';
  const returnButtonText = '';
  const forceTimeoutRedirectURL = '';
  let xmlData = `
  <?xml version='1.0' encoding='UTF-8' ?>
            ...
            <C130782>${paid[1] ? paid[1].due : ''}</C130782>
            <C130783>${paid[1] ? paid[1].fname + ' ' + paid[1].lname : ''}</C130783>
            <C130784>${paid[1] ? paid[1].grade : ''}</C130784>
            <C130785>${paid[2] ? paid[2].due : ''}</C130785>
            <C130786>${paid[2] ? paid[2].fname + ' ' + paid[2].lname : ''}</C130786>
            <C130787>${paid[2] ? paid[2].grade : ''}</C130787>
            <C130788>${paid[3] ? paid[3].due : ''}</C130788>
            <C130789>${paid[3] ? paid[3].fname + ' ' + paid[3].lname : ''}</C130789>
            <C130790>${paid[3] ? paid[3].grade : ''}</C130790>
            <C130791>${paid[4] ? paid[4].due : ''}</C130791>
            <C130792>${paid[4] ? paid[4].fname + ' ' + paid[4].lname : ''}</C130792>
            <C130793>${paid[4] ? paid[4].grade : ''}</C130793>
            <C130794>${total}</C130794>
